    ...
    const columns = [
      {
        ...
        render: (text, row, index) => {
          ...
          return (
            <div className={isSelected ? 'selected' : 'noraml'} onClick={() => this.selectBuilding(row, index)}>
              {' '}
              {text}
            </div>
          );
          ...
          <Row>
            ...
            <Col span={8}>
              <div className='doorList'>
                ...
                >
                  <Search placeholder='请输入单元名称' onSearch={value => this.filterUnits(value)} />
                </div>
                <div className='table'>
                  <PaginationTable
            ...
            <Col span={11}>
              <div className='titleBar'>
                <div className='left'>已选 ({pageSelectedValue}):</div>
                <div className='right' onClick={() => this.clearAll()}>
                  <Icon type='delete' />
